 ...
 * 
 * 使用方式：
 * 1. 在瀏覽器訪問：https://你的網址/wp-content/plugins/mygo-plus-one/test-seller-notification.php
 * 2. 輸入你的 LINE UID
 * 3. 點擊「發送測試通知」
 */
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['send_test'])) {
    ...
    if (empty($lineUid)) {
        ...
        $result = $lineService->sendSellerOrderNotification($lineUid, $testOrder);
...
<body>
    <div class="container">
        <h1>🔔 測試賣家訂單通知</h1>
        <p class="subtitle">發送測試的 LINE 訂單通知卡片</p>
        ...
        <div class="card-preview">
            ...
            <div class="preview-item">
                ...
                <span class="preview-value" style="color: #007aff;">用戶下單</span>
            </div>
            <div class="preview-item">
            ...
            <div class="preview-item">
                <span class="preview-label">買家姓名</span>
                <span class="preview-value">Fish 老魚</span>
            </div>
            <div class="preview-item">
                <span class="preview-label">商品名稱</span>
                <span class="preview-value">測試商品 0588</span>
            </div>
            <div class="preview-item">
                <span class="preview-label">商品數量</span>
                <span class="preview-value">1 個</span>
            </div>
            <div class="preview-item">
                <span class="preview-label">商品類別</span>
                <span class="preview-value">一般商品</span>
            </div>
            <div class="preview-item">
                <span class="preview-label">總計金額</span>
                <span class="preview-value" style="color: #007aff; font-weight: 700;">NT$ 350</span>
            </div>
            <div class="preview-item">
                <span class="preview-label">送貨/收貨方式</span>
                <span class="preview-value">自取</span>
            </div>
        </div>
